...
if ( ! class_exists( 'SPF_SMART_BRANDS_Fields' ) ) {
	/**
	 *
	 * Fields Class
	 *
	 ...
	 * @version 1.0.0
	 */
	abstract class SPF_SMART_BRANDS_Fields extends SPF_SMART_BRANDS_Abstract {
