...
(function($) {
  ...
  function SPF_SMART_BRANDSAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SPF_SMART_BRANDSAjaxChosen.prototype.init = function() {
  ...
  SPF_SMART_BRANDSAjaxChosen.prototype.events = function() {
  ...
  SPF_SMART_BRANDSAjaxChosen.prototype.search_field_focused = function() {
  ...
  SPF_SMART_BRANDSAjaxChosen.prototype.search_welcome_message = function() {
  ...
  SPF_SMART_BRANDSAjaxChosen.prototype.update_list = function() {
  ...
  SPF_SMART_BRANDSAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      this.element.SPF_SMART_BRANDSChosenOrder($hidden_value, true);
  ...
  $.fn.SPF_SMART_BRANDSAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new SPF_SMART_BRANDSAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, SPF_SMART_BRANDSAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SPF_SMART_BRANDSAbstractChosenOrder = (function() {

    function SPF_SMART_BRANDSAbstractChosenOrder() {}

    SPF_SMART_BRANDSAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    SPF_SMART_BRANDSAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    SPF_SMART_BRANDSAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SPF_SMART_BRANDSAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    SPF_SMART_BRANDSAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    SPF_SMART_BRANDSAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    SPF_SMART_BRANDSAbstractChosenOrder.SPF_SMART_BRANDSChosenOrder = function(select, order, force) {
    ...
    return SPF_SMART_BRANDSAbstractChosenOrder;
  ...
  $.fn.extend({
    SPF_SMART_BRANDSChosenOrder: function(order, force) {
      return _SPF_SMART_BRANDSChosenOrder.SPF_SMART_BRANDSChosenOrder(this, order, force);
    }
  });

  this._SPF_SMART_BRANDSChosenOrder = (function(_super) {
    __extends(_SPF_SMART_BRANDSChosenOrder, _super);

    function _SPF_SMART_BRANDSChosenOrder() {
      _ref = _SPF_SMART_BRANDSChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SPF_SMART_BRANDSChosenOrder.relAttributeName = 'data-option-array-index';

    _SPF_SMART_BRANDSChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SPF_SMART_BRANDSChosenOrder.getDOMElement = function(element) {
    ...
    _SPF_SMART_BRANDSChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _SPF_SMART_BRANDSChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SPF_SMART_BRANDSChosenOrder;

  })(SPF_SMART_BRANDSAbstractChosenOrder);
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectSPF_SMART_BRANDS = FormSerializer.serializeObject;
    $.fn.serializeJSONSPF_SMART_BRANDS   = FormSerializer.serializeJSON;
  }
