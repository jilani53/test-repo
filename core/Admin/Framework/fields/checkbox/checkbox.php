...
if ( ! class_exists( 'SPF_SMART_BRANDS_Field_checkbox' ) ) {
	/**
	 *
	 * Field: checkbox
	 *
	 ...
	 * @version 1.0.0
	 */
	class SPF_SMART_BRANDS_Field_checkbox extends SPF_SMART_BRANDS_Fields {
		...
		public function render() {
			...
			if ( isset( $this->field['options'] ) ) {
				...
				echo '<input type="hidden" name="' . esc_attr( $this->field_name() ) . '" value="' . esc_attr( $this->value ) . '" class="csf--input"' . $this->field_attributes() . '/>';//phpcs:ignore
				echo '<input type="checkbox" name="_pseudo" class="csf--checkbox"' . esc_attr( checked( $this->value, 1, false ) ) . $this->field_attributes() . '/>';//phpcs:ignore
